         ...
         <div class="card">
            <div class="body">
               <ol class="breadcrumb breadcrumb-bg-blue align-right">
                  ...
                  <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>Ceo massage</a></li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <form action="{{route('ceo.update',$ceo->id)}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        <div class="form-line">
                          <img src="{{URL::to($ceo->image)}}" style="height: 40px;width: 70px;">
                          <input type="hidden" name="old_image" value="{{$ceo->image}}">
                        </div>
                     </div>
                  </div>
               </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="body">
                            <textarea id="tinymce" name="massage">{{$ceo->massage}}</textarea>
                        </div>
