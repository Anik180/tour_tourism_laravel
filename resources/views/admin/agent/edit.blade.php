         ...
         <div class="card">
            <div class="body">
               <ol class="breadcrumb breadcrumb-bg-blue align-right">
                  ...
                  <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>Agent update</a></li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <form action="{{route('agents.update',$agent->id)}}" method="POST" enctype="multipart/form-data">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     ...
                     <img src="{{URL::to($agent->agent_image)}}" style="height: 40px;width: 70px;">
                     <input type="hidden" name="old_image" value="{{$agent->agent_image}}">
                  </div>
               </div>
               <br>
               <button type="submit" class="btn btn-primary m-t-15 waves-effect">Update</button>
               <a href="{{url('agents')}}" class="btn btn-danger m-t-15 waves-effect">back</a>
            </form>
         </div>
      </div>
   </div>
