        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                         <div class="header">
                         	<h2>Add Air ticket subcategory</h2>
                         </div>
                        <div class="body">
                            <form action="{{route('ticket-subcategories.store')}}" method="POST">
                            	@csrf
                                <div class="row">
                                <div class="col-md-6">
                                <label>Ait ticket subcategory name</label>
                                <div class="form-group ">
                                    <div class="form-line">
                                        <input type="text" name="ticket_subcategory" class="form-control" placeholder="Enter Ait ticket subcategory">
                                    </div>
                                </div>
                                </div>
                                <div class="col-md-6">
