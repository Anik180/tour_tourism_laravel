                    ...
                    <div class="card">
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-bg-blue align-right">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>gallery</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a href="{{route('gallery.create')}}" class="btn btn-success waves-effect">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                        <a href="{{ route('gallery.edit',$row->id) }}" class="btn btn-info waves-effect">
                                                    <i class="material-icons">edit</i>
                                                </a>
        
                                             <button class="btn btn-danger waves-effect" type="button" onclick="deleteGallery({{ $row->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $row->id }}" action="{{ route('gallery.destroy',$row->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
