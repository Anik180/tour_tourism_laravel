...
<div class="container-fluid">
         ...
         <div class="card">
            <div class="body">
               <ol class="breadcrumb breadcrumb-bg-blue align-right">
                  ...
                  <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>hHotel booking update</a></li>
               </ol>
            </div>
         </div>
      </div>
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         ...
         <div class="body">
            <form action="{{route('hotel-booking.update',$hotel_booking->id)}}" method="POST" enctype="multipart/form-data">
               @csrf
               @method('PUT')
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="form-group ">
                        <div class="form-line">
                           <input type="text" name="title" class="form-control" value="{{$hotel_booking->title}}">
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-lg-6">
                     ...
                     <img src="{{URL::to($hotel_booking->image)}}" style="height: 40px;width: 70px;">
                     <input type="hidden" name="old_image" value="{{$hotel_booking->image}}">
                  </div>
               </div>
               <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="body">
                        <textarea id="tinymce" name="detail">{{$hotel_booking->detail}}</textarea>
                     </div>
                  </div>
               </div>
               <br>
               <button type="submit" class="btn btn-primary m-t-15 waves-effect">Update</button>
               <a href="{{url('hotel-booking')}}" class="btn btn-danger m-t-15 waves-effect">back</a>
            </form>
         </div>
      </div>
   </div>
