        ...
        <div class="container-fluid">
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-bg-blue align-right">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>Package sub category</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                         <div class="header">
                         	<h2>Add Package sub category</h2>
                         </div>
                        <div class="body">
                            <form action="{{route('package-subcategory.store')}}" method="POST">
                            	@csrf
                                ...
                                <div class="form-group ">
                                    <div class="form-line">
                                        <input type="text" name="subcat" class="form-control" placeholder="Enter package category">
                                    </div>
                                </div>
                                </div>
                                </div>          
