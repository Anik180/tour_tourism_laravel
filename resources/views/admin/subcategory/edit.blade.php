        ...
        <div class="container-fluid">
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-bg-blue align-right">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">content_copy</i>package subcategory update</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                         <div class="header">
                         	<h2>Update Package subcategory</h2>
                         </div>
                        <div class="body">
                            <form action="{{route('package-subcategory.update',$packagesub->id)}}" method="POST" enctype="multipart/form-data">
                            	@csrf
                                @method('PUT')
                                <div class="row">
                                <div class="col-md-6">
                                <label>Package category name</label>ty
                                        ...
                                        <option value="{{$row->id}}" <?php if($row->id==$packagesub->package_category_id){echo "Selected";}?>>{{$row->package_category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                <label>Package Subcategory</label>
                                <div class="form-group ">
                                    <div class="form-line">
                                        <input type="text" name="subcat" class="form-control" value="{{$packagesub->subcat}}">
                                    </div>
                                </div>
                                </div>
                                </div>
                                ...
                                <a href="{{url('package-subcategory')}}" class="btn btn-danger m-t-15 waves-effect">back</a>
                            </form>
                        </div>
                    </div>
                </div>
