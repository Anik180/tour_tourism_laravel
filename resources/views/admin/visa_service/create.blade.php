...
<div class="container-fluid">
   ...
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         <div class="header">
            <h2>Add visa service</h2>
         </div>
         <div class="body">
            <form action="{{route('visa_services.store')}}" method="POST" enctype="multipart/form-data">
               @csrf
               <div class="row">
                  <div class="col-md-12">
                     <label>Title</label>
...
{{--                   <div class="col-md-6">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <label>Visa country name</label>
                     <select class="form-control show-tick" name="visa_id">
                        @foreach($visa as $row)
                        <option value="{{$row->id}}">{{$row->visa_country}}</option>
                        @endforeach
                     </select>
                  </div>
               </div>
               ...
               <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="body">
                        <textarea id="tinymce" name="visa_detail"></textarea>
                     </div>
                  </div>
               </div>
               <br>
